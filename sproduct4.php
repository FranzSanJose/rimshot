...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-row-image">
            <img src="product4.png" width="100%" id="MainImg" alt="">
        
    
</div>
        
        <div class="single-pro-details">
            <h4>Micahel Jordan Rimshot</h4>
            <h6>Black</h6>
            <h2> ₱500</h2>
            ...
            <span>Graphic tees are a type of t-shirt that features a graphic design, such as a logo, image, or text. They are a popular clothing item for people of all ages and genders. Graphic tees can be used to express personal style, interests, or beliefs.
                The design features sharp angles and geometric shapes in shades of pink and blue. Not just on the front, but also splashed across the back in a graffiti-style font.</span>
    ...
    <script src="sproduct4.js"> </script>
    <script>
